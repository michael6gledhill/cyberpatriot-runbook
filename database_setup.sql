...
-- 4. Team members table (for approval workflow)
...
-- 13. Create application MySQL user
...
-- Sample team
INSERT INTO teams (name, team_id, division) VALUES 
('Blue Squadron', '01-0001', 'CivilAirPatrol');
...
INSERT INTO users (name, email, password_hash, role, is_approved, is_active) VALUES 
('Admin User', 'admin@cyberpatriot.local', '$2b$12$placeholder', 'admin', TRUE, TRUE);

-- 15. Show tables and summary
SHOW TABLES;
